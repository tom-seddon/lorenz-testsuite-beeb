...
.PHONY:_everything
_everything: _adca _adcax _adcay _adcb _adcix _adciy _adcz _adczx _alrb _ancb _anda _andax _anday _andb _andix _andiy _andz _andzx _aneb _arrb _asla _aslax _asln _aslz _aslzx _asoa _asoax _asoay _asoix _asoiy _asoz _asozx _axsa _axsix _axsz _axszy _bccr _bcsr _beqr _bita _bitz _bmir _bner _bplr _brkn _bvcr _bvsr _clcn _cldn _clin _clvn _cmpa _cmpax _cmpay _cmpb _cmpix _cmpiy _cmpz _cmpzx _cntdef _cnto2 _cpuport _cputiming _cpxa _cpxb _cpxz _cpya _cpyb _cpyz _dcma _dcmax _dcmay _dcmix _dcmiy _dcmz _dcmzx _deca _decax _decz _deczx _dexn _deyn _eora _eorax _eoray _eorb _eorix _eoriy _eorz _eorzx _flipos _icr01 _imr _inca _incax _incz _inczx _insa _insax _insay _insix _insiy _insz _inszx _inxn _inyn _irq _jmpi _jmpw _jsrw _lasay _laxa _laxay _laxix _laxiy _laxz _laxzy _ldaa _ldaax _ldaay _ldab _ldaix _ldaiy _ldaz _ldazx _ldxa _ldxay _ldxb _ldxz _ldxzy _ldya _ldyax _ldyb _ldyz _ldyzx _loadth _lsea _lseax _lseay _lseix _lseiy _lsez _lsezx _lsra _lsrax _lsrn _lsrz _lsrzx _lxab _mmu _mmufetch _nmi _nopa _nopax _nopb _nopn _nopz _nopzx _oneshot _oraa _oraax _oraay _orab _oraix _oraiy _oraz _orazx _phan _phpn _plan _plpn _rlaa _rlaax _rlaay _rlaix _rlaiy _rlaz _rlazx _rola _rolax _roln _rolz _rolzx _rora _rorax _rorn _rorz _rorzx _rraa _rraax _rraay _rraix _rraiy _rraz _rrazx _rtin _rtsn _sbca _sbcax _sbcay sbc(eb) _sbcb _sbcix _sbciy _sbcz _sbczx _sbxb _secn _sedn _sein _shaay _shaiy _shsay _shxay _shyax _staa _staax _staay _staix _staiy _start _staz _stazx _stxa _stxz _stxzy _stya _styz _styzx _taxn _tayn _trap1-15 _trap16 _trap17 _tsxn _txan _txsn _tyan
...
.PHONY:_cntdef
_cntdef:
	$(MAKE) _asm "STEM=cntdef"

.PHONY:_cnto2
_cnto2:
	$(MAKE) _asm "STEM=cnto2"

.PHONY:_cpuport
_cpuport:
	$(MAKE) _asm "STEM=cpuport"

.PHONY:_cputiming
_cputiming:
	$(MAKE) _asm "STEM=cputiming"
...
.PHONY:_flipos
_flipos:
	$(MAKE) _asm "STEM=flipos"

.PHONY:_icr01
_icr01:
	$(MAKE) _asm "STEM=icr01"
...
.PHONY:_trap1-15
_trap1-15:
	$(MAKE) _asm "STEM=trap1-15"

.PHONY:_trap16
_trap16:
	$(MAKE) _asm "STEM=trap16"

.PHONY:_trap17
_trap17:
	$(MAKE) _asm "STEM=trap17"
...
.PHONY:_asm
_asm:
	$(TASS) -L "$(BUILD)/$(STEM).lst" -o "$(BEEB_BIN)/$$.$(STEM)" -T "./ascii-src/$(STEM).asm"
